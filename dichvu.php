...
<style>
.dv-banner{
	background: url(http://austcare.vn/global/media/c_product/dv-banner-jpg.jpeg) no-repeat center 0;
}
</style>
<div class="top-banner dv-banner">
</div>	
<div id="main" class="services-page">
	<div class="service-fix">
		<div class="inner">
			<h1 class="title">Dịch vụ sửa chữa cửa cuốn</h1>
						<div class="col dv">
				<a href="#" title=""><img src="http://austcare.vn/global/media/post/dv-png.png" alt=""></a>
				<h2>DỊCH VỤ SỬA CHỮA CỬA CUỐN 24/7</h2>
				<p><p><span style="color:rgb(88, 89, 91)">Bất cứ khi nào cửa cuốn gặp sự cố, hãy gọi cho chúng tôi. Nhân viên kỹ thuật của chúng tôi sẽ có mặt sau 30 phút</span></p>
</p>
			</div>
			
					<div class="col bt">
				<a href="#" title=""><img src="http://austcare.vn/global/media/post/baotri-png.png" alt=""></a>
				<h2>DỊCH VỤ BẢO TRÌ CỬA CUỐN</h2>
				<p><p><span style="color:rgb(88, 89, 91)">Định kỳ chăm sóc, kiểm tra để phát hiện & khắc phục sớm các sự cố. Đảm bảo cửa cuốn luôn trong tình trạng hoạt động tốt nhất. Giúp kéo dài tuổi thọ sử dụng cửa cuốn</span></p>
</p>
			</div>
			
					<div class="col lk">
				<a href="#" title=""><img src="http://austcare.vn/global/media/post/linhkien-png.png" alt=""></a>
				<h2>CUNG CẤP LINH KIỆN CỬA CUỐN CHÍNH HÃNG AUSTDOOR</h2>
				<p><p><span style="color:rgb(88, 89, 91)">Đảm bảo linh kiện chính hãng Austdoor, tư vấn lựa chọn linh kiện miễn phí</span></p>
</p>
			</div>
			
				</div>
	</div>
		<div class="enjoy yellow-bg">
		<div class="inner">
